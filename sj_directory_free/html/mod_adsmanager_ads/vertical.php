...
<div class="juloawrapper">
    ...
    ?>
        ...
        ?>
            ...
            echo "<h4 class='text-left no-margin-top'><a href='$linkTarget'>".$row->ad_headline."</a></h4>"; 
            ...
            foreach($adfields as $f) {
                ...
                if ($row->$fieldname != null) {
                    ...
                    echo "<div class='text-left'>$value</div>";
                }
            }
            ?>
            </li>
        ...
        if (isset($contents[0])){
			...
			?>
				...
				<?php	
					...
					if ($displaydate == 1){
						$date_short = JString::substr(reorderDate($row->date_created), 0, 5);
						
						echo "<span class=\"adsmanager-date\">".$date_short."</span>"; 
					}
					echo "<a class=\"recent-ads\" href='$linkTarget'>".$row->ad_headline."</a>";
				?>
				</li>
			<?php
			}
