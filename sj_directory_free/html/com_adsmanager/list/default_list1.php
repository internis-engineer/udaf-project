        ...
        <td>
			...
			if($content->parentid == 2 || $content->parentid == 22){
				...
				<div class="hearder-ad">
					...
					<p class="location"><?php echo $content->ad_city.$quartier; ?></p>
				</div>
				<?php
				...
				|| $content->parentid == 23 || $content->parentid == 18){
					...
					$titre = ($content->parentid) ? $content->ad_typevoiture.' | '.$content->ad_marque.' '.$content->ad_modele.' '.$content->ad_annee : $content->ad_headline;
						...
						if($content->parentid == 21 || $content->parentid == 25){
							...
							if ($content->parentid == 21){
								...
								$tableHtml .= '<div class="job_position">
										...
										<p>'.$deadline.' :<br/> '.$content->ad_applicationsdeadline.'</p></div>
										';
								...
								$tableHtml .= '<div class="job_position">
										<p>'.$af_text_short.'</p>
										<p>'.$typeContract.' :<br/> '.$content->cat.'</p>
										<p>'.$deadline.' :<br/> '.$content->ad_deadline.'</p></div>';
							}
