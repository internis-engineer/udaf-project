                    ...
                    foreach ($this->cats as $row) {
                        ...
                        if ($row->level == 0) {
                            ...
                            <div class="span<?php echo $classtype ?>">
                                <div class="span12">
                                   <div class="rubriques span6">
									   <ul>
										<h2 class="no-margin-top <?php echo $row->id ?> cat_title_<?php echo $row->name ?>">
											<a href="<?php echo $link; ?>"  ><?php echo htmlspecialchars($row->name)." (".$this->countEntriesByCat($row->id).")"; ?></a>
										</h2>
                            ...
                            // if ($firstsubcat == false)
                                // echo ' - ';
                            echo '<li><a href="'.$link.'">'.htmlspecialchars($row->name).$numAds.'</a></li>';
                            $firstsubcat = false;
                        }
